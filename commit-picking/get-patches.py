...
acrn_dirs = [
             ("arch/x86/acrn", data_after),
             ("drivers/acrn", data_after),
             ("drivers/char/vhm", data_after),
             ("drivers/char/rpmb/", data_after),
             ("drivers/dma-buf/hyper_dmabuf", data_after),
             ("drivers/trusty", data_after),
             ("drivers/vbs", data_after),
             ("drivers/vhm",  data_after),
             ("drivers/virtio",  data_after),
             ("include/linux/rpmb.h", data_after),
             ("include/linux/trusty/", data_after),
             ("include/linux/vhm/", data_after),
             ("include/uapi/linux/rpmb.h", data_after),
             ("include/uapi/linux/virtio_ids.h", data_after),
             ("tools/rpmb", data_after),
             ("Documentation/ABI/testing/sysfs-class-rpmb", data_after),
             ("Documentation/devicetree/bindings/trusty/", data_after),
             ("Documentation/virtual/acrn", data_after),
           ]
