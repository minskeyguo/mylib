...
# tilemap = [ [GRASS, GOLD, DIRT], [WATER, GRASS, WATER], [GOLD, GRASS, WATER], [DIRT, GRASS, GOLD], [GRASS, WATER, DIRT] ]
# tilemap = [ [ GRASS for w in range(MAP_WIDTH)] for h in range(MAP_HEIGHT) ]
